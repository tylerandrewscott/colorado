...
cert_df = data.frame(Certifiers = as.character(sort(unique(cert_state_links$Certifier))))

write.csv(cert_df,'input/competition_input/certifiers.csv')

w.the basic info needed is # of total organic operations per state, # of organic operations by state per certifier, and the states in which a certifier certifies.  
